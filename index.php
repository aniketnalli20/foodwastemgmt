...
<body>
    ...
    <section id="inspo-links" class="container fullbleed" aria-label="Helpful Links" style="padding: var(--content-pad);">
      <div class="footer-inspo">
        <div style="margin:0; text-align:left; width:100%;">
          <section class="faq card-plain" id="faqs" aria-label="FAQs" style="max-width:none; margin:0 0 12px; text-align:left;">
